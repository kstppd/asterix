...
int getNeighborhood(const uint dimension, const uint stencil) {
   ...
   if (stencil == 1) {
      switch (dimension) {
      case 0:
         return Neighborhoods::VLASOV_SOLVER_TARGET_X_NEIGHBORHOOD_ID;
      case 1:
         return Neighborhoods::VLASOV_SOLVER_TARGET_Y_NEIGHBORHOOD_ID;
      case 2:
         return Neighborhoods::VLASOV_SOLVER_TARGET_Z_NEIGHBORHOOD_ID;
      default:
         cerr << __FILE__ << ":"<< __LINE__ << " Wrong dimension, abort"<<endl;
         abort();
      }
   ...
   if (stencil == VLASOV_STENCIL_WIDTH) {
      switch (dimension) {
      case 0:
         return Neighborhoods::VLASOV_SOLVER_X_NEIGHBORHOOD_ID;
      case 1:
         return Neighborhoods::VLASOV_SOLVER_Y_NEIGHBORHOOD_ID;
      case 2:
         return Neighborhoods::VLASOV_SOLVER_Z_NEIGHBORHOOD_ID;
      default:
         cerr << __FILE__ << ":"<< __LINE__ << " Wrong dimension, abort"<<endl;
         abort();
      }
