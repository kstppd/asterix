...
std::size_t compress_vdf(GENERIC_TS_POOL::MemPool* p, const MatrixView<Real>& vcoords, const MatrixView<Real>& vspace, std::size_t fourier_order,
...
void uncompress_vdf(GENERIC_TS_POOL::MemPool* p,const MatrixView<Real>& vcoords, MatrixView<Real>& vspace, std::size_t fourier_order,
